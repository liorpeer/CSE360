...
public class MainApplet {
    //Constants
    private final static int LEFT_JUSTIFY = 1;
    private final static int RIGHT_JUSTIFY = 2;
    private final static int FULL_JUSTIFY = 3;

    //Global Variables
    private static int wordsProcessed, lines, blanksRemoved, spacesAdded;
    private static double averageWPL;
    private static double averageLL;
    private static TextFileAnalyzer textFileAnalyzer;
    private static String input, output;

    //Layouts
    private static FlowLayout flow_right = new FlowLayout(FlowLayout.RIGHT, 40, 20);
    //private static FlowLayout flow_center = new FlowLayout(FlowLayout.CENTER, 40, 20);

    //Text Fields - Windows Settings
    private static JTextField inputFile = new JTextField("", 15);
    private static JTextField outputFile = new JTextField("", 15);
    private static JTextField maxChars = new JTextField("80", 5);

    //Text Fields - Mac Settings
    //private static JTextField inputFile = new JTextField("", 13);
    //private static JTextField outputFile = new JTextField("", 13);

    //Labels
    private static JLabel formatData = new JLabel();
    private static JLabel inputLabel = new JLabel("Select Input File:");
    private static JLabel outputLabel = new JLabel("Select Output File:");
    private static JLabel justifyLabel = new JLabel("Justification:");
    private static JLabel spacingLabel = new JLabel("Spacing:");
    private static JLabel maxCharLabel = new JLabel("How many characters would you like in the formated text file?");

    //Fonts
    private static Font font = new Font("name", Font.PLAIN, 14);

    //Buttons
    private static JButton inputBrowseButton = new JButton("Browse");
    private static JButton outputBrowseButton = new JButton("Browse");
    private static JButton formatButton = new JButton("Format my File");
    private static JButton resetButton = new JButton("Reset");

    //Radio Buttons
    private static JRadioButton leftJustifyButton = new JRadioButton("Left (Default)");
    private static JRadioButton rightJustifyButton = new JRadioButton("Right");
    private static JRadioButton fullJustifyButton = new JRadioButton("Left/Right (Full)");
    private static JRadioButton singleSpaceButton = new JRadioButton("Single Spaced (Default)");
    private static JRadioButton doubleSpaceButton = new JRadioButton("Double Spaced");
    ...
    private static class ButtonHandler implements ActionListener {
        public void actionPerformed(ActionEvent e){
            ...
            if(source == inputBrowseButton) {
                ...
                int lineLength = Integer.parseInt(maxChars.getText());

                try {
                    if(doubleSpaceButton.isSelected()) {
                        if (leftJustifyButton.isSelected()) {
                            textFileAnalyzer = new TextFileAnalyzer(input, output, LEFT_JUSTIFY, lineLength, true);
                        } else if (rightJustifyButton.isSelected()) {
                            textFileAnalyzer = new TextFileAnalyzer(input, output, RIGHT_JUSTIFY, lineLength, true);
                        } else {
                            textFileAnalyzer = new TextFileAnalyzer(input, output, FULL_JUSTIFY, lineLength, true);
                        }
                    }
                    else {
                        if (leftJustifyButton.isSelected()) {
                            textFileAnalyzer = new TextFileAnalyzer(input, output, LEFT_JUSTIFY, lineLength, false);
                        } else if (rightJustifyButton.isSelected()) {
                            textFileAnalyzer = new TextFileAnalyzer(input, output, RIGHT_JUSTIFY, lineLength, false);
                        } else {
                            textFileAnalyzer = new TextFileAnalyzer(input, output, FULL_JUSTIFY, lineLength, false);
                        }
                    }
                }
     ...
     * </html>
     */
    private static void setTextFormatDataLabel() {
        formatData.setText(
                "<html> <table>" +
